...
namespace EjemploGuiadoClienteNetworking
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Si la conexión se ha establecido se crean los Streams y se inicial la comunicación siguiendo el protocolo 
            ...
            using (StreamWriter sw = new StreamWriter(ns))
            {
                ...
                while (true)
                {
                    ...
                    //Enviamos el mensaje de usuario al servidor que que el servidor está esperando que le envíen algo
